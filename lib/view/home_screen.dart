  ...
  Widget buildSearchBar(bool isDark) {
    return Padding(
      ...
      child: GlobalUtils.CustomButton(
        onPressed: () => Get.to(() => const SearchScreen(), transition: Transition.fadeIn),
        height: 55,
              ...
              return Obx(()=> Row(
                children: [
                  GlobalUtils.CustomButton(
                    ...
                    animation: ButtonAnimation.scale,
                    padding: EdgeInsets.zero,
                    child: ClipRRect(child: Image.network(homeScreenController.banner[index].image.toString(), width: GlobalUtils.screenWidth, height: GlobalUtils.screenHeight, fit: BoxFit.fill,), borderRadius: BorderRadius.circular(20),),
                  ),
        ...
        Padding(
          ...
          child: GridView.builder(
            ...
            gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
              ...
              childAspectRatio: 0.57, // Defines the base aspect ratio for items
            ),
