...
class Data {
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    if (json['maleWellness'] != null) {
      ...
      json['maleWellness'].forEach((v) {
        maleWellness!.add(new MaleWellness.fromJson(v));
      });
    }
    if (json['femaleWellness'] != null) {
      femaleWellness = <FemaleWellness>[];
      json['femaleWellness'].forEach((v) {
        femaleWellness!.add(new FemaleWellness.fromJson(v));
      });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.maleWellness != null) {
      data['maleWellness'] = this.maleWellness!.map((v) => v.toJson()).toList();
    }
    if (this.femaleWellness != null) {
      data['femaleWellness'] =
          this.femaleWellness!.map((v) => v.toJson()).toList();
    }
    return data;
  }
}
